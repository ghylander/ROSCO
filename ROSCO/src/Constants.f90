...
MODULE Constants
    ...
    REAL(8), PARAMETER          :: PI = 3.1415926                       ! Mathematical constant pi
    INTEGER(8), PARAMETER       :: NP_1 = 1                             ! First rotational harmonic
    INTEGER(8), PARAMETER       :: NP_2 = 2                             ! Second rotational harmonic
